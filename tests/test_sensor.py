...
from custom_components.tuya_local_custom.helpers.device_config import TuyaEntityConfig
from custom_components.tuya_local_custom.sensor import TuyaLocalSensor, async_setup_entry
